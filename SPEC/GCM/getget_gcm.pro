function getget_gcm, name, charvar, count=count, offset=offset, stride=stride, coordmean=coordmean, anomaly=anomaly
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; name: char
; charvar: char
...
ENDIF ELSE BEGIN
  ...
  ;
  var = intarr(4)
  ;NCDF_DIMINQ, id, NCDF_DIMID(id, 'lon'  ), toto, titi & var(0) = titi
  ;NCDF_DIMINQ, id, NCDF_DIMID(id, 'lat'  ), toto, titi & var(1) = titi 
  ;NCDF_DIMINQ, id, NCDF_DIMID(id, 'sigma'), toto, titi & var(2) = titi
  ;NCDF_DIMINQ, id, NCDF_DIMID(id, 'time' ), toto, titi & var(3) = titi 
  NCDF_DIMINQ, id, NCDF_DIMID(id, 'longitude'  ), toto, titi & var(0) = titi
  NCDF_DIMINQ, id, NCDF_DIMID(id, 'latitude'  ), toto, titi & var(1) = titi
  NCDF_DIMINQ, id, NCDF_DIMID(id, 'altitude'), toto, titi & var(2) = titi
  NCDF_DIMINQ, id, NCDF_DIMID(id, 'Time' ), toto, titi & var(3) = titi
  ;print, var
