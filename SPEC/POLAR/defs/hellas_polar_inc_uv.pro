;;;;;*************************************** FOLDER
	folder  = '/home/aslmd/ALTIERI/ALTIERI_1HELLAS/'
        coord2d = 'true'       ;; for non-regular projections  ;;CHANGER windowx and windowy
	filename        = folder + 'wrfout_d01_2024-07-02_06:00:00_zabg'
...
;;;;;*************************************** LVL & FLD & TIME
	nlevel          = 0 
	use_lt          = 02. ;-3 ;12 ;14 ;99 ;12           ;; cf. what user wants (99 pour tous, negatif pour indice)
	;field1          = 'UTSM'        ;; comment to trace horizontal velocity
	;field2  	= 'XLAT' 	;; contour
	no3d            = 'true'
...
;;;;;*************************************** PLOT TITLES
	...
	subtitle_user   = subtitle_user + ' / Ls = 180!Uo!N'
	subtitle_user   = subtitle_user + ' / dx = 30km [S]'
