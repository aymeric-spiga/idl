...
;;;;;*************************************** PLOT TITLES
	title_user	=	'' ;'Vertical wind speed (z-component) (m s!U-1!N)'
        subtitle_user   =       'LT = 02:00am  /  Ls = 173!Uo!N  /  dx = 6km [single]  /  Uniform TI = 85 J m!U-2!N s!U-0.5!N K!U-1!N'
        title_axis      =       ['Vertical wind velocity (m s!U-1!N)', 'Altitude above the surface (m)']
        if (mention eq 'two') then title_axis      =      ['Horizontal wind speed (m s!U-1!N)', 'Altitude above the surface (m)']
        if (mention eq 'three') then title_axis      =      ['Atmospheric temperature (K)', 'Altitude above the surface (m)']
...
;;;;;*************************************** COLOR TABLES
	...
	poscb		=	0.96
        ...
        ;colors          =       128
        colors          =       32
        pal             =       0 ;22              ;; GOOD: 4, 18, 22, 16, 37, 33, 39, 6, 11

;;;;;*************************************** FILL LIMITS
        minfield_init   =       -15.
        maxfield_init   =       2.5
        if (mention eq 'two') then minfield_init   =       0.001
        if (mention eq 'two') then maxfield_init   =       40.
        if (mention eq 'three') then minfield_init   =       160.
        if (mention eq 'three') then maxfield_init   =       230.
...
;;;;;*************************************** AXIS
        ...
        ;intervaly       =	intervalx
	intervaly	=	0.1
        if (mention eq 'two') then intervalx = 5.
        if (mention eq 'three') then intervalx = 10.
