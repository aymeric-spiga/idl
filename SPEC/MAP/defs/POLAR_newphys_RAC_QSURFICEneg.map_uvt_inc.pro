;;;;;*************************************** FOLDER
	...
	coord2d = 'polar'       ;; for polar projection with map_set ;; utiliser use_lt=99
        ...
        save_ps         = 'POLAR_newphys_RAC_QSURFICEneg'

;;;;;*************************************** LVL & FLD & TIME
        nlevel          = 0
        use_lt          = 24;99               ;; cf. what user wants (99 pour tous)
        field1          = 'QSURFICE'       ;; comment to trace horizontal velocity
        ;field2         = 'XLAT'           ;; contour
        no3d            = 'true'
...
;;;;;*************************************** TWEAK VAR
        ...
        what_I_plot = abs(what_I_plot * 1.e6 / 920.)
        ;print, max(what_I_plot), min(what_I_plot)

;;;;;*************************************** PLOT TITLES
        title_user 	= 	'Hollowed surface water ice (microns)' 
...
;;;;;*************************************** COLOR TABLES
	...
	poscb		=	0.85
        format          =       '(I0)' 
        colors          =       32
        pal             =       33;22              ;; GOOD: 4, 18, 22, 16, 37, 33, 39, 6, 11
