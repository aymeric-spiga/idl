...
field1         = 'LWDOWNZ'      ;; comment to trace horizontal velocity
no3d 		= 'true'
...
;;;;;*************************************** PLOT TITLES
	...
	;title_user	=	'Upward sensible heat flux at the surface (W m!U-2!N)'
	title_user	=	'Downward longwave radiative flux at the surface (W m!U-2!N)'
